...
import com.kobito.sample.data.db.LocalDateConverter
import com.kobito.sample.internal.DateNotFoundException
...
import kotlinx.android.synthetic.main.future_detail_weather_fragment.textView_uv
...
class FutureDetailWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    private fun bindUI() = launch(Dispatchers.Main) {
        ...
        weatherLocation.observe(
            this@FutureDetailWeatherFragment,
            Observer { location ->
                if (location == null)
                    return@Observer
        ...
        futureWeather.observe(
            this@FutureDetailWeatherFragment,
            Observer { weatherEntry ->
    ...
    private fun updateTemperatures(avg: Double, min: Double, max: Double) {
        val unitAbbreviation = chooseLocalizedUnitAbbreviation("°C", "°F")
        textView_temperature.text = "$avg$unitAbbreviation"
